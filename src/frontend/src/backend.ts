...
export class Backend implements backendInterface {
    ...
    async listProjectsView(): Promise<Array<[string, Time]>> {
        if (this.processError) {
            try {
                const result = await this.actor.listProjectsView();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveProject(arg0: string, arg1: EditSettings): Promise<void> {
        if (this.processError) {
            try {
